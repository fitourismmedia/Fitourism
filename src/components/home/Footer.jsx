  ...
  return (
    <footer className="border-t border-border bg-secondary px-5 py-12 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-3"><img src="/logo.png" alt="Logo" className="h-11 w-11" /><div><div className="font-display text-3xl font-semibold">Fitourism</div><div className="font-mono text-[10px] uppercase tracking-[0.24em] text-primary">Tourism LLC</div></div></div>
        ...
        <div><h4 className="font-mono text-xs uppercase tracking-[0.22em] text-primary">Contact</h4><div className="mt-5 space-y-3 text-muted-foreground"><p className="flex gap-2"><Phone className="h-4 w-4" /> +971 50 166 0310</p><p className="flex gap-2"><Mail className="h-4 w-4" /> airport@fitourism.com</p></div></div>
      ...
      <div className="mx-auto mt-10 max-w-7xl border-t border-border pt-6 font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground">© 2026 Fitourism. All rights reserved.</div>
    </footer>
  );
}